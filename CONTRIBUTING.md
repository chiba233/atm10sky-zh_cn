...
| 脚本 | 作用 |
|---|---|
| `fetch_pack.py` | 把某个版本的 All the Mods 10: To the Sky 备齐成一个可当 `ATM_PACK_ROOT` 用的目录 |
...
$EDITOR build/common/resourcepacks/ATM10Sky汉化包/assets/<模组>/patchouli_books/…/x.json
