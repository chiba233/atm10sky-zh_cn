...
//
//   一、生效。资源包里埋了一个只有我们定义的键 atm10skyzhcn.pack.version
//       （assets/atm10skyzhcn/lang/zh_cn.json，值由构建脚本按发布版本现填）。
...
(function () {
  const PROBE_KEY = 'atm10skyzhcn.pack.version'
  const PROBE_NAMESPACE = 'atm10skyzhcn'
