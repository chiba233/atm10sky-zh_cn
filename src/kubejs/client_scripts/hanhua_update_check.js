...
//    发生」。2026-08-01 实机踩过两次。拿整包 ATM10 Sky 的 kubejs 对照过：上游能跑的
...
(function () {
  ...
  const RELEASES_URL = 'https://github.com/chiba233/atm10sky-zh_cn/releases/latest'
  const API_URL = 'https://api.github.com/repos/chiba233/atm10sky-zh_cn/releases/latest'
  ...
  function done(message) {
    ...
    if (message) console.warn('[ATM10 Sky 汉化] ' + message)
  }
  ...
  function startRequest() {
    ...
    try {
      ...
      request.setHeader('User-Agent', 'atm10sky-zh_cn-update-checker')
  ...
  ClientEvents.tick(event => {
    ...
    if (!matched) {
      console.warn('[ATM10 Sky 汉化] 更新检查：响应里没有 tag_name')
      return
    }
    ...
    if (latestVersion === null) {
      console.warn('[ATM10 Sky 汉化] 更新检查：看不懂的版本号 ' + latest)
      return
    }
